...
<div class="conteiner">
    ...
    <div class="conteiner-top">
        ...
        <form method="post" id="formProveedor" class="form-horizontal" > 
                    ...
                    <?php foreach ($proveedores as $prov): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" style="display:inline-block" onsubmit="return confirm('¿Estás seguro de que quieres eliminar a este proveedor? (Se deshabilitará)')">
